const services = [
  {
    ...
    icon: (
      <svg className="ico" viewBox="0 0 60 60" fill="none" stroke="currentColor" strokeWidth="1.2">
        ...
        <circle cx="30" cy="30" r="9" /><circle cx="30" cy="30" r="3" fill="currentColor" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="ico" viewBox="0 0 60 60" fill="none" stroke="currentColor" strokeWidth="1.2">
        <ellipse cx="16" cy="34" rx="11" ry="9" /><ellipse cx="44" cy="34" rx="11" ry="9" />
        <path d="M27 34 Q30 30 33 34" /><path d="M5 32 L2 28" /><path d="M55 32 L58 28" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="ico" viewBox="0 0 60 60" fill="none" stroke="currentColor" strokeWidth="1.2">
        <circle cx="30" cy="30" r="20" /><circle cx="30" cy="30" r="13" /><circle cx="30" cy="30" r="6" />
  ...
  },
  {
    ...
    icon: (
      <svg className="ico" viewBox="0 0 60 60" fill="none" stroke="currentColor" strokeWidth="1.2">
        <path d="M10 20 L50 20 L46 40 L14 40 Z" /><path d="M22 40 L20 50" /><path d="M38 40 L40 50" />
  ...
  },
  {
    ...
    more: 'Industrial & athletic',
    icon: (
      <svg className="ico" viewBox="0 0 60 60" fill="none" stroke="currentColor" strokeWidth="1.2">
        <path d="M8 32 L20 14 L40 14 L52 32 L40 50 L20 50 Z" />
        <circle cx="30" cy="32" r="7" /><path d="M16 22 L26 32" /><path d="M44 22 L34 32" />
      </svg>
    ),
  },
  {
    ...
    <section className="services" id="services">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <h2>Comprehensive vision care,<br />crafted with <em>care</em>.</h2>
          <p>From the eye exam to the final frame adjustment, every step is handled in-house by people who know your name.</p>
        </div>
        <div className="svc-grid">
          {services.map((s, i) => (
            <div key={s.num} className={`svc reveal${i > 0 && i % 3 !== 0 ? ` delay-${i % 3}` : ''}`}>
              <span className="num">{s.num}</span>
              {s.icon}
              <h3>{s.title}</h3>
              <p>{s.desc}</p>
              <span className="more">{s.more} <span>→</span></span>
            </div>
          ))}
        </div>
      </div>
